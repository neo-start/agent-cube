...
type EventHandler = (event: GroupMessage) => void;
...
class EventBus {
   ...
   */
  emit(event: Partial<GroupMessage> & { type: string; from: string; content: string }): GroupMessage {
   ...
   */
  getHistory(sinceIndex = 0): GroupMessage[] {
