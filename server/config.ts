...
export const DIRECT_CHATS_DIR = path.join(DATA_DIR, 'direct-chats');

[DATA_DIR, MEMORY_DIR, LOGS_DIR, UPLOADS_DIR, SOULS_DIR, LONG_TERM_DIR, INBOX_DIR, THREADS_DIR, WORKSPACES_DIR, DIRECT_CHATS_DIR].forEach(d => fs.mkdirSync(d, { recursive: true }));
