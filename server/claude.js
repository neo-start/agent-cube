/**
 * claude.js — Built-in Anthropic API proxy for agent-cube
 ...
 * @param {string} opts.userMessage - The new user message to send
 * @param {string} [opts.model] - Model override
 * @param {number} [opts.maxTokens] - Max tokens override
 * @param {Function} opts.onDelta - Called with (deltaText) for each streamed chunk
